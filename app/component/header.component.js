...
var HeaderComponent = (function () {
    function HeaderComponent() {
        this.tabs = [
            ...
            { title: '关于', removable: true, routerLink: '/about', describe: '点我进入 [关于] => 了解我的前世今生~' },
            { title: 'Tommy', removable: true, routerLink: '/tommy', describe: '点我进入 [Tommy] => 伟大的作者爸爸=.=' },
            { title: '注册', removable: true, routerLink: '/signin', describe: '点我进入 [注册] => 来安个家吧!' },
            { title: '登录', removable: true, routerLink: 'login', describe: '点我进入 [登录] => 脱鞋进来看看吧.!.' },
        ];
    }
